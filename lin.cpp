...
//                qDebug () << "Serie:"<< NSerie;
//                qDebug () << "Valor:" <<Valor;
//                qDebug () << "Guardar:" << Guardar;
//                qDebug () << "Sig:" << Siguiente;
...
//                qDebug () << "NS/VAL " << NSerie << Valor;
//                qDebug () << "Flag " << Guardar <<" " << Siguiente;;
...
//qDebug () << CC << VSoft;
           ...
           //     Valor = CC.toLong(&ok,10);
                ...
                if(DD<10)
                    CC.append("0");
                CC.append(QString::number(DD,10));
                if(MM<10)
                    CC.append("0");
                CC.append(QString::number(MM,10));
                if(AA<10)
                    CC.append("0");
                CC.append(QString::number(AA,10));
